...
export function loader() {
  ...
  return { investment, chartsData };
}

export default function Investment() {
  const { investment, chartsData } = useLoaderData<typeof loader>();
        ...
        <Table>
          <TableHeader className="w-full rounded-xl bg-muted/50">
            <TableRow>
              ...
              <TableHead className="w-[20%]">Invested</TableHead>
              <TableHead className="w-[20%]">Yield generated</TableHead>
            </TableRow>
          </TableHeader>
