...
export function meta() {
  return [{ title: "Renewable Energy | CARBON Copy ReFi Impact Dashboard" }];
}
...
export default function RenewableEnergy() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 overflow-x-hidden relative">
      ...
      <div className="h-fit w-full min-h-[100vh] flex flex-col flex-1 md:min-h-min">
        <h2 className="text-[22px] font-bold">Projects</h2>
        <Table className="space-y-2">
          <TableHeader className="w-full rounded-xl bg-muted/50">
            <TableRow>
              <TableHead className="w-[20%]">Project</TableHead>
              <TableHead className="w-[15%]">Energy Generated</TableHead>
              <TableHead className="w-[15%]">CO2 Emissions Saved</TableHead>
              <TableHead className="w-[15%]">Solar Panels</TableHead>
            </TableRow>
          </TableHeader>
