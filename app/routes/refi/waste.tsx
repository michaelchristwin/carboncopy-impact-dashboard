...
export function meta() {
  return [{ title: "Waste | CARBON Copy ReFi Impact Dashboard" }];
}
...
export function loader() {
  ...
  return { waste, wasteX, chartsData };
}

export default function Waste() {
  const { waste, wasteX, chartsData } = useLoaderData<typeof loader>();
        ...
        <Table>
          <TableHeader className="w-full rounded-xl bg-muted/50">
            <TableRow>
              ...
              <TableHead className="w-[20%]">Collected (t)</TableHead>
