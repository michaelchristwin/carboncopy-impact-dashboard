...
export function meta() {
  return [{ title: "Grants | CARBON Copy ReFi Impact Dashboard" }];
}
...
export function loader() {
  ...
  return { grants, chartsData };
}

export default function Grants() {
  const { grants, chartsData } = useLoaderData<typeof loader>();
        ...
        <Table>
          <TableHeader className="w-full rounded-xl bg-muted/50">
            <TableRow>
              ...
              <TableHead className="w-[20%]">Grants</TableHead>
              <TableHead className="w-[20%]">Granted</TableHead>
            </TableRow>
          </TableHeader>
